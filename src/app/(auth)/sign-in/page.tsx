  ...
  return (
    <main className="flex flex-1 flex-col items-center justify-center gap-4 px-6 py-24 text-center">
      ...
      <p className="max-w-md font-[family-name:var(--font-body)] text-base text-[var(--color-navy-ink)]/80">
        The review flow behind sign-in is still being built.
      </p>
      <Link
        href="/"
        className="mt-2 font-[family-name:var(--font-display)] text-sm font-semibold uppercase tracking-wide text-[var(--color-navy)] underline decoration-2 underline-offset-4 hover:text-[var(--color-red)]"
      >
