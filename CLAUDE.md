...
- All copy a user reads in this product — the landing page, UI labels, error messages, and empty states — has to be run through the humanizer skill before it's committed. Copy that reads as though a model wrote it is a defect, not a matter of taste.
